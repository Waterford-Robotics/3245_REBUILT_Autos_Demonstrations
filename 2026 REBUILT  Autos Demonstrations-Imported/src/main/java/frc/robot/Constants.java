...
public final class Constants {
  ...
  public static final class ControllersConstants {
      ...
      public static final int k_climbUpButton = Button.kRightBumper.value;
      public static final int k_climbDnButton = Button.kLeftBumper.value;
      public static final int k_intakeButton = Button.kX.value;
      public static final int k_ampRevButton = Button.kA.value;
      public static final int k_ampButton = Button.kB.value;
      public static final int k_ShootRevButton = Axis.kLeftTrigger.value;
      public static final int k_ShootButton = Axis.kRightTrigger.value;
  }

  public static class AutoTimeConstants {
    public static final double shootRevAutoTime = 2.0;
    public static final double shootRevAutoTimeShort = 1.5;
    public static final double shootAutoTime = 2.5;
    public static final double shootAutoTimeShort = 2.0;
  }
  ...
  public static final class ShooterConstants {
    public static final int k_shootRPort = 0;
    public static final int k_shootLPort = 1;
    public static final int k_shootKPort = 2;
    public static final double k_shootRevSpeed = 0.9;
    public static final double k_intakeRevSpeed = -0.8;
    public static final double k_ampTopSpeed = -0.85;
    public static final double k_ampBotSpeed = 0.75;
  }
  
  public static final class ClimberConstants{
    public static final int k_climberPort = 3;
    public static final double k_climberSpeed = 0.6;
  }
